            ...
            <div class="container">
                ...
                <div id="navbar-collapse" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><a href="<?= base_url('daftar') ?>">Pendaftaran</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="row probootstrap-gutter0">
                            ...
                            <div class="col-md-7 col-md-push-1  probootstrap-animate" id="probootstrap-content">
                                ...
                                <p>Lengkapi profile dibawah ini untuk mendapatkan akses dan melanjutkan pendaftaran</p>
                                <?php if ($this->session->flashdata('msg') != NULL) :
                                    echo $this->session->flashdata('msg');
                                endif;
                                ?>
                                <form action="<?= base_url('submit-daftar') ?>" method="post" class="probootstrap-form">
