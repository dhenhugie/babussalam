            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <button class="btn btn-primary float-right" data-toggle="modal" data-target="#modal-default">Tambah data</button>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <tbody>
                      <?php foreach ($jurusan as $key) { ?>
                        <tr>
                          ...
                          <td><a href="<?= base_url('hapus-jurusan/') . $key->id ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a></td>
                        </tr>
                      <?php } ?>
                    </tbody>
                  </table>
      ...
      <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
          <div class="modal-content">
            <form action="<?= base_url('simpan-jurusan') ?>" method="post">
              ...
              <div class="modal-body">
                <input type="text" name="jurusan" id="jurusan" placeholder="Masukan Nama Jurusan" class="form-control" required>
              </div>
